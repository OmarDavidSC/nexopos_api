...
-- Volcando datos para la tabla db_nexopos_app.inventory_movements: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla db_nexopos_app.product_stocks: ~7 rows (aproximadamente)
INSERT INTO `product_stocks` (`id`, `company_id`, `branch_id`, `product_id`, `current_stock`, `minimum_stock`, `created_at`, `updated_at`, `deleted_at`) VALUES
	...
	(27, 4, 1, 4, 30.00, 10.00, '2026-07-10 17:52:54', '2026-07-10 17:52:54', NULL),
...
INSERT INTO `users` (`id`, `foto_id`, `name`, `paternal_surname`, `maternal_surname`, `username`, `email`, `password`, `status`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(38, 1384, 'Brian Arturo', 'Coronado', 'Nizama', 'brian', 'omarsc@gmail.com', '$2y$10$xgmK7Nlc34AR1WmqwVn8teNNBPvw6.9byqeStOT7Ay8PJj.07B1JC', 1, '2025-06-12 17:34:03', '2026-07-09 18:24:31', NULL),
